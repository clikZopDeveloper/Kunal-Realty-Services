...
class GetCustomerAdapter(
    var context: Activity,
    var list: List<CustomerBean.Data>,
    var rvClickListner: RvStatusClickListner
) : RecyclerView.Adapter<GetCustomerAdapter.MyViewHolder>(), Filterable {
    var mFilteredList: MutableList<CustomerBean.Data> = list as MutableList<CustomerBean.Data>
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                if (charString.isEmpty()) {
                    mFilteredList = list as MutableList<CustomerBean.Data>
                } else {
                    val filteredList = ArrayList<CustomerBean.Data>()
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                mFilteredList = filterResults.values as ArrayList<CustomerBean.Data>
